        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#f5f6fa">
            <tr>
                <td style="padding: 40px 0">
                    ...
                    <h3 style="padding-top:10px;padding-bottom:5px;padding-left: 137px;">Bonjour, {{ $chauffeur_updates[0]['modifier']['name']}} demande la suppréssion du chauffeur {{ $chauffeur_updates[0]['chauffeur']['nom']}} possedant le RFID : {{ $chauffeur_updates[0]['chauffeur']['rfid']}} </h3>
                    <h3 style="padding-top:10px;padding-bottom:5px;padding-left: 137px;">Voici le détails des informations du chauffeur </h3>
